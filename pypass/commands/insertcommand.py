...
class InsertCommand( CommandInterface ):
	name = 'insert'
	...
	def execute( self, args, gpg ):
		...
		entryPath = self.repository.entryPath( args.entry )
		...
		if entry.parent.recipients() is None:
